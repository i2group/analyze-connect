...
import com.example.demo.rest.transport.ItemFactory;
import com.example.demo.rest.transport.LinkData;
import com.example.demo.rest.transport.request.Payload;
...
public class ExternalConnectorDataService {
  ...
  private ConnectorResponse marshalItemsFromResponse(SocrataResponse response) {
    ...
    final Map<Integer, EntityData> complaints = new HashMap<>();
