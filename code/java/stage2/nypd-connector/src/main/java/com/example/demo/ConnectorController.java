...
public class ConnectorController {
    ...
    /**
     * Create an instance of the ConnectorDataService used to complete acquires
     */
    ...
    /*
     * Defines the /all endpoint which acquires the test-service data (entities and links)
