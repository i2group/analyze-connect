...
public class ConnectorController {
    ...
    /**
     * Defines the seeded search endpoint which acquires the seeded search data (entities and links based on seeds)
     ...
     */
    @RequestMapping(method = RequestMethod.POST, value = "SEEDED SEARCH ACQUIRE URL GOES HERE", consumes = APPLICATION_JSON_VALUE, produces = APPLICATION_JSON_VALUE)
