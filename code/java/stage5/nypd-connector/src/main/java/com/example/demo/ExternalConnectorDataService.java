...
/**
 * Used to query the Socrata database, turning the raw data into entities and links that can be shown in ANBP
 */
@Service
public class ExternalConnectorDataService {
    ...
    /**
     * Contains the data to setup the Socrata connection
     * @param baseUrl URL of the socrata database
     * @param apiToken API Token used to access the socrata database
     */
    @Autowired
    ...
    public ConnectorResponse retrieveTestDataFromExternalSource() {
        ...
        // Make the request and map the response to an object model and print each
        // object
