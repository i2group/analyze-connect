          ...
          <div>
            ...
            ${"authorizationCode"===e||"clientCredentials"===e||"implicit"===e||"password"===e?D`
                <button class="m-btn thin-border" part="btn btn-outline"
                  @click="${t=>{eR.call(this,n,e,s,l,t)}}"
                > GET TOKEN </button>`:""}
          </div>
          <div class="oauth-resp-display red-text small-font-size"></div>
          `:""}
    </div>
  `}function rR(e){var t;const r=null===(t=this.resolvedSpec.securitySchemes)||void 0===t?void 0:t.find((t=>t.securitySchemeId===e));if(r.user="",r.password="",r.value="",r.finalKeyValue="","true"===this.persistAuth){const e=GP.call(this);delete e[r.securitySchemeId],KP.call(this,e)}this.requestUpdate()}function nR(){var e;if(!this.resolvedSpec)return"";const t=null===(e=this.resolvedSpec.securitySchemes)||void 0===e?void 0:e.filter((e=>e.finalKeyValue));return t?D`
  <section id='auth' part="section-auth" style="text-align:left; direction:ltr; margin-top:24px; margin-bottom:24px;" class = 'observe-me ${"read focused".includes(this.renderStyle)?"section-gap--read-mode":"section-gap "}'>
    ...
    <div class="small-font-size" style="display:flex; align-items: center; min-height:30px">
      ${t.length>0?D`
          ...
          <button class="m-btn thin-border" part="btn btn-outline" @click=${()=>{VP.call(this)}}>CLEAR ALL API KEYS</button>`:D`<div class="red-text">No API key applied</div>`}
    </div>
              ...
              <td style="max-width:500px; overflow-wrap: break-word;">
                <div style="line-height:28px; margin-bottom:5px;">
                  ...
                  ${e.finalKeyValue?D`
                      ...
                      <button class="m-btn thin-border small" part="btn btn-outline" @click=${()=>{rR.call(this,e.securitySchemeId)}}>REMOVE</button>
                      `:""}
                </div>
                ${e.description?D`
                    ...
                    <div style="max-height:28px;">
                      ${"cookie"!==e.in?D`
                          ...
                          <button class="m-btn thin-border" style = "margin-left:5px;"
                            ...
                            @click="${t=>{YP.call(this,e.securitySchemeId,t)}}">
            ...
            ${"oauth2"===e.type.toLowerCase()?D`
                <tr>
                  <td style="border:none; padding-left:48px">
                    ${Object.keys(e.flows).map((t=>tR.call(this,t,e["x-client-id"],e["x-client-secret"],e.securitySchemeId,e.flows[t],e["x-default-scopes"],e["x-receive-token-in"])))}
                  </td>
                </tr>
                `:""}
          `))}
  ...
  <div class="tab-panel col"
    ...
    ${e.map(((e,t)=>{var r,n,a;return D`
      <div class="tab-content m-markdown" style= "display:${0===t?"block":"none"}" data-tab = '${e.lang}${t}'>
        ...
        <pre><code class="language">${He().languages[null===(r=e.lang)||void 0===r?void 0:r.toLowerCase()]?MP(He().highlight(e.source,He().languages[null===(n=e.lang)||void 0===n?void 0:n.toLowerCase()],null===(a=e.lang)||void 0===a?void 0:a.toLowerCase())):e.source}</code></pre>
      </div>`}))}
  </section>`}function iR(e){return D`
    ...
    `))}
  `}const sR={},lR=zP(class extends UP{constructor(){super(...arguments),this.nt=sR}render(e,t){return t()}update(e,[t,r]){if(Array.isArray(t)){if(Array.isArray(this.nt)&&this.nt.length===t.length&&t.every(((e,t)=>e===this.nt[t])))return N}else if(this.nt===t)return N;return this.nt=Array.isArray(t)?Array.from(t):t,this.render(t,r)}}),{H:cR}=X,pR={},uR=zP(class extends UP{constructor(e){if(super(e),e.type!==NP&&e.type!==BP&&e.type!==FP)throw Error("The `live` directive is not allowed on child or event bindings");if(!(e=>void 0===e.strings)(e))throw Error("`live` bindings can only contain a single expression")}render(e){return e}update(e,[t]){if(t===N||t===F)return t;const r=e.element,n=e.name;if(e.type===NP){if(t===r[n])return N}else if(e.type===FP){if(!!t===r.hasAttribute(n))return N}else if(e.type===BP&&r.getAttribute(n)===t+"")return N;return((e,t=pR)=>{e._$AH=t})(e),t}});var dR=r(131),hR=r.n(dR);const fR=l`
.border-top {
  border-top:1px solid var(--border-color);
}
.border{
...
`;customElements.define("schema-tree",class extends ne{static get properties(){return{data:{type:Object},schemaExpandLevel:{type:Number,attribute:"schema-expand-level"},schemaDescriptionExpanded:{type:String,attribute:"schema-description-expanded"},allowSchemaDescriptionExpandToggle:{type:String,attribute:"allow-schema-description-expand-toggle"},schemaHideReadOnly:{type:String,attribute:"schema-hide-read-only"},schemaHideWriteOnly:{type:String,attribute:"schema-hide-write-only"}}}connectedCallback(){super.connectedCallback(),(!this.schemaExpandLevel||this.schemaExpandLevel<1)&&(this.schemaExpandLevel=99999),this.schemaDescriptionExpanded&&"true false".includes(this.schemaDescriptionExpanded)||(this.schemaDescriptionExpanded="false"),this.schemaHideReadOnly&&"true false".includes(this.schemaHideReadOnly)||(this.schemaHideReadOnly="true"),this.schemaHideWriteOnly&&"true false".includes(this.schemaHideWriteOnly)||(this.schemaHideWriteOnly="true")}static get styles(){return[We,jR,fR,l`
      ...
      <div class="tree ${"true"===this.schemaDescriptionExpanded?"expanded-descr":"collapsed-descr"}">
        ...
        ${null!==(r=this.data)&&void 0!==r&&r["::description"]?D`<span part="schema-description" class='m-markdown'> ${MP(qe(this.data["::description"]||""))}</span>`:""}
        ${this.data?D`
    ...
    `}generateTree(e,t="object",r="",n="",a="",o=0,i=0,s=""){var l;if("true"===this.schemaHideReadOnly){if("array"===t&&"readonly"===s)return;if(e&&"readonly"===e["::readwrite"])return}if("true"===this.schemaHideWriteOnly){if("array"===t&&"writeonly"===s)return;if(e&&"writeonly"===e["::readwrite"])return}if(!e)return D`<div class="null" style="display:inline;">
        ...
        <div class="tr ${o<this.schemaExpandLevel||null!==(y=e["::type"])&&void 0!==y&&y.startsWith("xxx-of")?"expanded":"collapsed"} ${e["::type"]||"no-type-info"}" title="${e["::deprecated"]?"Deprecated":""}">
          ...
          <div class='td key-descr m-markdown-small'>${MP(qe(a||""))}</div>
        </div>
      ...
      <div class = "tr primitive" title="${A?"Deprecated":""}">
        ...
        <div class='td key-descr'>
          ${"array"===t?D`<span class="m-markdown-small">${MP(qe(a))}</span>`:""}
          ${k?D`<span class="m-markdown-small">
              ${MP(qe(`${S?`**${S}:**`:""} ${k} ${b||x||w||$?'<span class="more-content">⤵</span>':""}`))}
              </span>`:S?D`${S} ${b||x||w||$?D`<span class="more-content">⤵</span>`:""}`:""}
    ...
    <div class="col regular-font request-panel ${"read focused".includes(this.renderStyle)||"true"===this.callback?"read-mode":"view-mode"}">
      ...
      <div>
        ${lR([this.allowTry,this.parameters,this.activeParameterSchemaTabs],(()=>this.inputParametersTemplate("path")))}
        ${lR([this.allowTry,this.parameters,this.activeParameterSchemaTabs],(()=>this.inputParametersTemplate("query")))}
        ${this.requestBodyTemplate()}
        ${lR([this.allowTry,this.parameters,this.activeParameterSchemaTabs],(()=>this.inputParametersTemplate("header")))}
        ${lR([this.allowTry,this.parameters,this.activeParameterSchemaTabs],(()=>this.inputParametersTemplate("cookie")))}
    ...
    ${r.length>0?D`<span style="font-weight:bold">Example: </span>
        ${r.map(((r,n)=>{var a,o,i;return D`
          ...
          ${"array"===t?"] ":""}
        `}))}
      `:""}`}inputParametersTemplate(e){const t=this.parameters?this.parameters.filter((t=>t.in===e)):[];if(0===t.length)return"";let r="";"path"===e?r="PATH PARAMETERS":"query"===e?r="QUERY-STRING PARAMETERS":"header"===e?r="REQUEST HEADERS":"cookie"===e&&(r="COOKIES");const n=[];for(const r of t){const[t,a,o]=CR(r);if(!t)continue;const i=mR(t);if(!i)continue;const s=ER(t,{});let l="form",c=!0,p=!1;"query"===e&&(r.style&&"form spaceDelimited pipeDelimited".includes(r.style)?l=r.style:a&&(l=a),"boolean"==typeof r.explode&&(c=r.explode),"boolean"==typeof r.allowReserved&&(p=r.allowReserved));const u=gR(r.examples||yR(r.example)||yR(null==o?void 0:o.example)||(null==o?void 0:o.examples)||i.examples||yR(i.example),i.type);u.exampleVal||"object"!==i.type||(u.exampleVal=OR(t,a||"json","","",!(this.schemaHideReadOnly&&(this.schemaHideReadOnly.includes(this.method)||"true"===this.schemaHideReadOnly)),!(this.schemaHideWriteOnly&&(this.schemaHideWriteOnly.includes(this.method)||"true"===this.schemaHideWriteOnly)),"text",!1)[0].exampleValue);const d="read focused".includes(this.renderStyle)?"200px":"160px";n.push(D`
        ...
        ${"true"===this.allowTry?D`
            ...
            anchor:anchor, anchor-param-example:anchor-param-example"
                    ...
                    <input type="${"password"===i.format?"password":"text"}" spellcheck="false" style="width:100%" 
                      ...
                      data-array="false"
                      .value="${"no"===r["x-fill-example"]?"":uR("true"===this.fillRequestFieldsWithExample?u.exampleVal:"")}"
                    />`}
            </td>`:""}
      ...
      <tr>
        ...
        <td colspan="2" style="border:none">
          <span class="m-markdown-small">${MP(qe(r.description||""))}</span>
    ...
    <div style="display:block; overflow-x:auto; max-width:100%;">
      ...
      `,o.forEach((e=>{let o,i=[];if(this.selectedRequestBodyType.includes("json")||this.selectedRequestBodyType.includes("xml")||this.selectedRequestBodyType.includes("text")||this.selectedRequestBodyType.includes("jose"))e.mimeType===this.selectedRequestBodyType&&(i=OR(e.schema,e.mimeType,e.examples,e.example,!(this.schemaHideReadOnly&&(this.schemaHideReadOnly.includes(this.method)||"true"===this.schemaHideReadOnly)),!(this.schemaHideWriteOnly&&(this.schemaHideWriteOnly.includes(this.method)||"true"===this.schemaHideWriteOnly)),"text",!1),this.selectedRequestBodyExample||(this.selectedRequestBodyExample=i.length>0?i[0].exampleId:""),a=D`
            ${a}
            <div class = 'example-panel border-top pad-top-8'>
              ...
              ${i.filter((e=>e.exampleId===this.selectedRequestBodyExample)).map((t=>D`
                <div class="example ${t.exampleId===this.selectedRequestBodyExample?"example-selected":""}" data-example = '${t.exampleId}'>
                  ...
                  ${t.exampleDescription?D`<div class="m-markdown-small" style="padding: 4px 0"> ${MP(qe(t.exampleDescription||""))} </div>`:""}
          ...
          `);else if(this.selectedRequestBodyType.includes("form-urlencoded")||this.selectedRequestBodyType.includes("form-data")){if(e.mimeType===this.selectedRequestBodyType){const t=OR(e.schema,e.mimeType,e.examples,e.example,!(this.schemaHideReadOnly&&(this.schemaHideReadOnly.includes(this.method)||"true"===this.schemaHideReadOnly)),!(this.schemaHideWriteOnly&&(this.schemaHideWriteOnly.includes(this.method)||"true"===this.schemaHideWriteOnly)),"text",!1);e.schema&&(r=this.formDataTemplate(e.schema,e.mimeType,t[0]?t[0].exampleValue:""))}}else/^audio\/|^image\/|^video\/|^font\/|tar$|zip$|7z$|rtf$|msword$|excel$|\/pdf$|\/octet-stream$/.test(this.selectedRequestBodyType)&&e.mimeType===this.selectedRequestBodyType&&(t=D`
          ...
          `);(e.mimeType.includes("json")||e.mimeType.includes("xml")||e.mimeType.includes("text")||this.selectedRequestBodyType.includes("jose"))&&(o=ER(e.schema,{}),"table"===this.schemaStyle?n=D`
            ${n}
            <schema-table
      ...
      <div class='request-body-container' data-selected-request-body-type="${this.selectedRequestBodyType}">
        ...
        ${this.request_body.description?D`<div class="m-markdown" style="margin-bottom:12px">${MP(qe(this.request_body.description))}</div>`:""}
    ...
    `}formDataParamAsObjectTemplate(e,t,r){var n;const a=ER(t,{}),o=OR(t,"json",t.examples,t.example,!(this.schemaHideReadOnly&&(this.schemaHideReadOnly.includes(this.method)||"true"===this.schemaHideReadOnly)),!(this.schemaHideWriteOnly&&(this.schemaHideWriteOnly.includes(this.method)||"true"===this.schemaHideWriteOnly)),"text",!1);return D`
    ...
    `}formDataTemplate(e,t,r=""){const n=[];if(e.properties){for(const r in e.properties){var a,o;const i=e.properties[r];if(i.readOnly)continue;const s=i.examples||i.example||"",l=i.type,c=mR(i),p="read focused".includes(this.renderStyle)?"200px":"160px",u=gR(c.examples||c.example,c.type);n.push(D`
        ...
        ${"object"===l?"":D`
            <tr>
              ...
              <td colspan="2" style="border:none; margin-top:0; padding:0 5px 8px 5px;"> 
                <span class="m-markdown-small">${MP(qe(i.description||""))}</span>
      ...
      <textarea
        ...
        style="width:100%"
      ></textarea>
      ${e.description?D`<span class="m-markdown-small">${MP(qe(e.description))}</span>`:""}
      ...
      <div class="tab-panel col" style="border-width:0 0 1px 0;">
        ...
        ${this.responseIsBlob?D`
            <div class="tab-content col" style="flex:1; display:${"response"===this.activeResponseTab?"flex":"none"};">
              ...
              ${"view"===this.responseBlobType?D`<button class="m-btn thin-border mar-top-8" style="width:135px"  @click='${e=>{!function(e){if(e){const t=document.createElement("a");document.body.appendChild(t),t.style="display: none",t.href=e,t.target="_blank",t.click(),t.remove()}}(this.responseBlobUrl)}}' part="btn btn-outline">VIEW (NEW TAB)</button>`:""}
            </div>`:D`
            <div class="tab-content col m-markdown" style="flex:1; display:${"response"===this.activeResponseTab?"flex":"none"};" >
              ...
              <pre style="white-space:pre; min-height:50px; height:var(--resp-area-height, 400px); resize:vertical; overflow:auto">${e?D`<code>${MP(He().highlight(this.responseText,He().languages[e],e))}</code>`:`${this.responseText}`}</pre>
            </div>`}
        <div class="tab-content col m-markdown" style="flex:1; display:${"headers"===this.activeResponseTab?"flex":"none"};" >
          ...
          <pre style="white-space:pre"><code>${MP(He().highlight(this.responseHeaders,He().languages.css,"css"))}</code></pre>
        </div>
        <div class="tab-content col m-markdown" style="flex:1; display:${"curl"===this.activeResponseTab?"flex":"none"};">
          ...
          <pre style="white-space:pre"><code>${MP(He().highlight(this.curlSyntax.trim().replace(/\\$/,""),He().languages.shell,"shell"))}</code></pre>
        </div>
      </div>`}apiCallTemplate(){let e="";this.servers&&this.servers.length>0&&(e=D`
    ...
    `}generateTree(e,t="object",r="",n="",a="",o=0,i=0,s=""){var l,c;if("true"===this.schemaHideReadOnly){if("array"===t&&"readonly"===s)return;if(e&&"readonly"===e["::readwrite"])return}if("true"===this.schemaHideWriteOnly){if("array"===t&&"writeonly"===s)return;if(e&&"writeonly"===e["::readwrite"])return}if(!e)return D`<div class="null" style="display:inline;">
        ...
        ${p>=0&&n?D`
            <div class='tr ${p<=this.schemaExpandLevel?"expanded":"collapsed"} ${e["::type"]}' data-obj='${h}' title="${e["::deprecated"]?"Deprecated":""}">
              ...
              <div class='td key-descr m-markdown-small' style='line-height:1.7'>${MP(qe(a||""))}</div>
            </div>`:D`
    ...
    <div class='expanded-endpoint-body observe-me ${e.method} ${e.deprecated?"deprecated":""} ' part="section-operation ${e.elementId}" id='${e.elementId}'>
      ...
      ${e.description?D`<div class="m-markdown"> ${MP(qe(e.description))}</div>`:""}
      ...
      <div class='expanded-req-resp-container'>
        ...
        ${e.callbacks?iR.call(this,e.callbacks):""}
...
`:""}function RR(e){return D`
  ...
  ${this.resolvedSpec.components.map((e=>D`
    <div id="cmp--${e.name.toLowerCase()}" class='regular-font section-gap--read-mode observe-me' style="border-top:1px solid var(--primary-color);">
      ...
      <div class="regular-font-size">
        ${MP(`<div class='m-markdown regular-font'>${qe(e.description?e.description:"")}</div>`)}
      </div>
    </div>
    ...
    `))}
`:""}function DR(){const e=new qe.Renderer;return e.heading=(e,t,r,n)=>`<h${t} class="observe-me" id="overview--${n.slug(r)}">${e}</h${t}>`,e}function NR(){var e,t,r;return D`
  ...
  `}function FR(e){var t;const r=null===(t=this.resolvedSpec)||void 0===t?void 0:t.servers.find((t=>t.url===e));return!!r&&(this.selectedServer=r,this.requestUpdate(),this.dispatchEvent(new CustomEvent("api-server-change",{bubbles:!0,composed:!0,detail:{selectedServer:r}})),!0)}function zR(e,t){const r=[...e.currentTarget.closest("table").querySelectorAll("input, select")];let n=t.url;r.forEach((e=>{const t=new RegExp(`{${e.dataset.var}}`,"g");n=n.replace(t,e.value)})),t.computedUrl=n,this.requestUpdate()}function UR(){return this.selectedServer&&this.selectedServer.variables?D`
    ...
    <table class='m-table'>
      ${Object.entries(this.selectedServer.variables).map((e=>D`
        ...
        ${e[1].description?D`<tr><td colspan="2" style="border:none"><span class="m-markdown-small"> ${MP(qe(e[1].description))} </span></td></tr>`:""}
      `))}
    </table>
...
`}function GR(e){const t=new qe.Renderer;return t.heading=(t,r,n,a)=>`<h${r} class="observe-me" id="${e}--${a.slug(n)}">${t}</h${r}>`,t}function KR(e){return D`
    <div class='regular-font section-gap--focused-mode' part="section-operations-in-tag">
      ${e}
    </div>`}function JR(){var e;if("true"===this.showInfo)return KR(NR.call(this));const t=this.resolvedSpec.tags[0],r=null===(e=this.resolvedSpec.tags[0])||void 0===e?void 0:e.paths[0];return KR(t&&r?IR.call(this,r,t.name):"")}function YR(e){return D`
    <h1 id="${e.elementId}">${e.name}</h1>
    ${"show-description"===this.onNavTagClick&&e.description?D`
        <div class="m-markdown">
          ${MP(`\n            <div class="m-markdown regular-font">\n              ${qe(e.description||"","true"===this.infoDescriptionHeadingsInNavBar?{renderer:GR(e.elementId)}:void 0)}\n            </div>`)}
        </div>`:""}
  `}function ZR(){if(!this.focusedElementId||!this.resolvedSpec)return;const e=this.focusedElementId;let t,r=null,n=null,a=0;if(e.startsWith("overview")&&"true"===this.showInfo)t=NR.call(this);else if("auth"===e&&"true"===this.allowAuthentication)t=nR.call(this);else if("servers"===e&&"true"===this.allowServerSelection)t=qR.call(this);else if("operations-top"===e)t=D`
    <div id="operations-top" class="observe-me">
      <slot name="operations-top"></slot>
    </div>`;else if(e.startsWith("cmp--")&&"true"===this.showComponents)t=BR.call(this);else if(e.startsWith("tag--")){const r=e.indexOf("--",4)>0?e.substring(0,e.indexOf("--",5)):e;n=this.resolvedSpec.tags.find((e=>e.elementId===r)),t=n?KR.call(this,YR.call(this,n)):JR.call(this)}else{for(a=0;a<this.resolvedSpec.tags.length&&(n=this.resolvedSpec.tags[a],r=this.resolvedSpec.tags[a].paths.find((t=>`${t.elementId}`===e)),!r);a+=1);if(r){MR(this.shadowRoot.getElementById(`link-${e}`),"expand"),t=KR.call(this,IR.call(this,r,n.name))}else t=JR.call(this)}return t}function QR(e){if(e.expanded)e.expanded=!1,"true"===this.updateRoute&&window.history.replaceState(null,null,`${window.location.href.split("#")[0]}${"#"===this.routePrefix?"":`${this.routePrefix}`}`);else if(e.expanded=!0,"true"===this.updateRoute){const t=`${this.routePrefix||"#"}${e.elementId}`;window.location.hash!==t&&window.history.replaceState(null,null,`${window.location.href.split("#")[0]}${t}`)}this.requestUpdate()}function XR(e,t="expand-all"){const r=[...e.querySelectorAll(".section-tag")];"expand-all"===t?r.map((e=>{e.classList.replace("collapsed","expanded")})):r.map((e=>{e.classList.replace("expanded","collapsed")}))}function eL(e,t="expand-all"){XR.call(this,e.target.closest(".operations-root"),t)}function tL(e,t=!1){return D`
  ...
  <div part="section-endpoint-body-${e.expanded?"expanded":"collapsed"}" class='endpoint-body ${e.method} ${e.deprecated?"deprecated":""}'>
    <div class="summary">
      ...
      ${e.description?D`<div part="section-endpoint-body-description" class="m-markdown"> ${MP(qe(e.description))}</div>`:""}
      <slot name="${e.elementId}"></slot>
      ${aR.call(this,e.security)}
      ${s}
    </div>  
...
`}
    ...
    `}resetSelection(){this.selectedStatus="",this.selectedMimeType=""}responseTemplate(){if(!this.responses)return"";for(const n in this.responses){this.selectedStatus||(this.selectedStatus=n);const a={};for(const r in null===(e=this.responses[n])||void 0===e?void 0:e.content){var e,t;const o=this.responses[n].content[r];this.selectedMimeType||(this.selectedMimeType=r);const i=ER(o.schema,{}),s=OR(o.schema,r,o.examples,o.example,!(this.schemaHideReadOnly&&(this.schemaHideReadOnly.includes(this.method)||"true"===this.schemaHideReadOnly)),!(this.schemaHideWriteOnly&&(this.schemaHideWriteOnly.includes(this.method)||"true"===this.schemaHideWriteOnly)),r.includes("json")?"json":"text");a[r]={description:this.responses[n].description,examples:s,selectedExample:(null===(t=s[0])||void 0===t?void 0:t.exampleId)||"",schemaTree:i}}const o=[];for(const e in null===(r=this.responses[n])||void 0===r?void 0:r.headers){var r;o.push({name:e,...this.responses[n].headers[e]})}this.headersForEachRespStatus[n]=o,this.mimeResponsesForEachStatus[n]=a}return D`
      ...
      ${Object.keys(this.responses).map((e=>{var t,r;return D`
        <div style = 'display: ${e===this.selectedStatus?"block":"none"}' >
          <div class="top-gap">
            <span class="resp-descr m-markdown ">${MP(qe((null===(t=this.responses[e])||void 0===t?void 0:t.description)||""))}</span>
    ...
    `}responseHeaderListTemplate(e){return D`
        ...
        ${e.map((e=>D`
          <tr>
            ...
            <td style="padding:8px; vertical-align: baseline; border-top: 1px solid var(--light-border-color);text-overflow: ellipsis;">
              <div class="m-markdown-small regular-font" >${MP(qe(e.description||""))}</div>
            </td>
            <td style="padding:8px; vertical-align: baseline; border-top: 1px solid var(--light-border-color); text-overflow: ellipsis;">
              ${e.schema.example||""}
            </td>
      ...
      ${1===e.examples.length?D`
          ${"json"===e.examples[0].exampleFormat?D`
              ...
              ${e.examples[0].exampleDescription?D`<div class="m-markdown-small" style="padding: 4px 0"> ${MP(qe(e.examples[0].exampleDescription||""))} </div>`:""}
              <json-tree 
                render-style = '${this.renderStyle}'
...
`;function iL(){var e;return document.addEventListener("close",(()=>{this.showAdvancedSearchDialog=!1})),document.addEventListener("open",this.onOpenSearchDialog),D`
  ...
  *, *:before, *:after { box-sizing: border-box; }
        ...
        <div class="main-content-inner--${this.renderStyle}-mode">
          ${!0===this.loading?D`<div class="loader"></div>`:D`
              ${!0===this.loadFailed?D`<div style="text-align: center;margin: 16px;"> Unable to load the Spec</div>`:D`
                  ...
                  ${"focused"===this.renderStyle?D`${ZR.call(this)}`:D`
                      ${"true"===this.showInfo?NR.call(this):""}
                      ${"true"===this.allowServerSelection?qR.call(this):""}
                      ${"true"===this.allowAuthentication?nR.call(this):""}
                      <div id="operations-top" class="observe-me">
                        <slot name="operations-top"></slot>
                      </div>  
  ...
  `}function fL(){return D`
    ...
    ${this.resolvedSpec.schemaAndExamples.map((e=>{var t;const r=OR(e.schema,"json",e.examples,e.example,!0,!1,"json",!0);return e.selectedExample=null===(t=r[0])||void 0===t?void 0:t.exampleId,D`
        <section id='${e.elementId}' class='json-schema-and-example regular-font' style="display:flex; flex-direction: column; border:1px solid var(--border-color); margin-bottom:32px; border-top: 5px solid var(--border-color)">
          <div style="padding:16px; border-bottom: 1px solid var(--border-color)">
            ...
            <span class="json-schema-description m-markdown ">${MP(qe(e.description||""))}</span>
          </div>  
